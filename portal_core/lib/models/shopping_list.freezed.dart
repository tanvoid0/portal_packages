...
class _$ShoppingListImpl implements _ShoppingList {
  ...
  @override
  String toString() {
    return 'ShoppingList(id: $id, name: $name, sortOrder: $sortOrder, isDefault: $isDefault, icon: $icon)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, sortOrder, isDefault, icon);
...
abstract class _ShoppingList implements ShoppingList {
  const factory _ShoppingList(
      ...
      final String? icon}) = _$ShoppingListImpl;
